...
namespace Deep42\Hitchhiker\Http\Livewire;
...
use Deep42\Hitchhiker\Contracts\ModuleActivator;
use Deep42\Hitchhiker\Services\StepManager;
...
class Installer extends Component
{
    ...
    public function next(): void
    {
        ...
        try {
            if ($this->currentStepId === 'environment' && ! $this->testDatabase()) {
                return;
            }
    ...
    public function finish(): void
    {
        ...
        // 6. Dispatch success event for the completion panel
        ...
        try {
            if (! method_exists($step, 'testConnection')) {
                $this->testConnectionResult = [
                    'success' => false,
                    'message' => __('installer::installer.error_generic'),
                ];
