...
use Deep42\Hitchhiker\Services\DotEnvWriter;
use Deep42\Hitchhiker\Services\FileInstallationStateManager;
...
class InstallerServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        if ($this->app->runningInConsole()) {
            $this->commands([
                \Deep42\Hitchhiker\Console\Commands\MakeInstallerStepCommand::class,
            ]);
        }
    }
